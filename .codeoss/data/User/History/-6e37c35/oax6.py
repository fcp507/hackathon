...
def compare_players(prompt: str) -> str:
    ...
    minor_query = """
    SELECT *, Relinquished as Name, ` SO` as SO, ` BK` as BK
    FROM `theta-shuttle-446821-i9.mlb.milb_testing_data`
    """
    
    major_query = """
    SELECT Name, Age as currentAge, ERA, WHIP, SO, BK
    FROM `theta-shuttle-446821-i9.mlb.mlb_comparison_stats_2024`
